...
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = getResources().getColor(R.color.colorGreen, null);
    ...
    public void setProgressAnimate(int targetProgress) {
        mProgress = 0;
        this.targetProgress = Math.min(targetProgress, mMaxProgress);
        mFinish = false;
